    ...
    return (
        <BottomNavigation 
            ...
            <BottomNavigationAction 
                ...
                label="Ämtli" 
                icon={
                    <Badge badgeContent={choreNews} color="secondary"><AssignmentIcon className={classes.icon} /></Badge>
                }
                component={Link}
            ...
            <BottomNavigationAction 
                ...
                label="Belohnungen" 
                icon={
                    <Badge badgeContent={rewardNews} color="secondary"><RedeemIcon className={classes.icon} /></Badge>
                }
                component={Link}
            ...
            <BottomNavigationAction 
                ...
                label="Profil" 
                icon={
                    <Badge badgeContent={profileNews} color="secondary"><AssignmentIndIcon className={classes.icon} /></Badge>
                }
                component={Link}
